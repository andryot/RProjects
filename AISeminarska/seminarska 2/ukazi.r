...
sum(month(podatki$datum) == 5 & izobrazevalna) #manjkajo predvsem podatki od poletnih mesecev pri izobraževalnih ustanovah

sum(month(podatki$datum) == 1 & poslovna)

sum(month(podatki$datum) == 5 & poslovna)

teden <-  c("ponedeljek", "torek", "sreda", "èetrtek", "petek", "sobota", "nedelja");
